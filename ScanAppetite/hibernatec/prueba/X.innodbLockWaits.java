...
import prueba.X.innodbLockWaitsId;
...
public class X.innodbLockWaits  implements java.io.Serializable {
    ...
    @AttributeOverrides( {
        ...
        @AttributeOverride(name="waitingQuery", column=@Column(name="waiting_query", length=1024) ), 
        ...
        @AttributeOverride(name="blockingQuery", column=@Column(name="blocking_query", length=1024) ), 
