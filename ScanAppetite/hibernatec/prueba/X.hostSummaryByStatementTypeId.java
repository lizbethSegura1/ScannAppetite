...
public class X.hostSummaryByStatementTypeId  implements java.io.Serializable {
    ...
    public X.hostSummaryByStatementTypeId(long total, long totalLatency, long maxLatency, long lockLatency, long cpuLatency, long rowsSent, long rowsExamined, long rowsAffected, long fullScans) {
        this.total = total;
    ...
    public X.hostSummaryByStatementTypeId(String host, String statement, long total, long totalLatency, long maxLatency, long lockLatency, long cpuLatency, long rowsSent, long rowsExamined, long rowsAffected, long fullScans) {
       this.host = host;
