...
public class X.schemaTableStatisticsWithBufferId  implements java.io.Serializable {
    ...
    @Column(name="innodb_buffer_allocated", precision=44, scale=0)
    ...
    @Column(name="innodb_buffer_data", precision=44, scale=0)
    ...
    @Column(name="innodb_buffer_free", precision=45, scale=0)
    ...
    @Column(name="innodb_buffer_rows_cached", precision=45, scale=0)
