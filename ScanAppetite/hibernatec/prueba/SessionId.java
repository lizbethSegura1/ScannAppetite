...
public class SessionId implements java.io.Serializable {
	...
	public SessionId(long thdId, String fullScan) {
		this.thdId = thdId;
		this.fullScan = fullScan;
	}

	public SessionId(long thdId, Long connId, String user, String db, String command, String state, Long time,
			String currentStatement, String executionEngine, String statementLatency, BigDecimal progress,
			String lockLatency, String cpuLatency, Long rowsExamined, Long rowsSent, Long rowsAffected, Long tmpTables,
			Long tmpDiskTables, String fullScan, String lastStatement, String lastStatementLatency,
			String currentMemory, String lastWait, String lastWaitLatency, String source, String trxLatency,
			String trxState, String trxAutocommit, String pid, String programName) {
		this.thdId = thdId;
		this.connId = connId;
		this.user = user;
		this.db = db;
	...
	@Column(name = "last_statement_latency", length = 11)
	...
	@Column(name = "last_wait_latency", length = 13)
	...
	@Column(name = "trx_latency", length = 11)
	...
	public boolean equals(Object other) {
		...
		return (this.getThdId() == castOther.getThdId())
				...
				&& ((this.getExecutionEngine() == castOther.getExecutionEngine())
						|| (this.getExecutionEngine() != null && castOther.getExecutionEngine() != null
								&& this.getExecutionEngine().equals(castOther.getExecutionEngine())))
