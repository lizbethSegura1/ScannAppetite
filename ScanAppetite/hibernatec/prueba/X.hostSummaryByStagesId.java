...
public class X.hostSummaryByStagesId  implements java.io.Serializable {
    ...
    public X.hostSummaryByStagesId(String eventName, long total, long totalLatency, long avgLatency) {
        this.eventName = eventName;
        this.total = total;
        this.totalLatency = totalLatency;
        this.avgLatency = avgLatency;
    }
    public X.hostSummaryByStagesId(String host, String eventName, long total, long totalLatency, long avgLatency) {
       this.host = host;
       this.eventName = eventName;
       this.total = total;
       this.totalLatency = totalLatency;
