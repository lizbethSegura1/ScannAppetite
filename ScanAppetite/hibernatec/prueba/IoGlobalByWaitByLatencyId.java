...
public class IoGlobalByWaitByLatencyId implements java.io.Serializable {
	...
	@Column(name = "read_latency", length = 11)
	...
	@Column(name = "write_latency", length = 11)
	...
	@Column(name = "misc_latency", length = 11)
	...
	@Column(name = "total_read", length = 11)
	...
	@Column(name = "avg_read", length = 11)
	...
	@Column(name = "total_written", length = 11)
	...
	@Column(name = "avg_written", length = 11)
