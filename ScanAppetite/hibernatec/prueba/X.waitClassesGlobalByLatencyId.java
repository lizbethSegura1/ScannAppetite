...
public class X.waitClassesGlobalByLatencyId  implements java.io.Serializable {
    ...
    public X.waitClassesGlobalByLatencyId(String eventClass, BigInteger total, BigInteger totalLatency, Long minLatency, BigDecimal avgLatency, Long maxLatency) {
