...
/**
 * InnodbBufferStatsBySchemaId generated by hbm2java
 */
@Embeddable
public class InnodbBufferStatsBySchemaId implements java.io.Serializable {
	...
	public InnodbBufferStatsBySchemaId() {
	}

	public InnodbBufferStatsBySchemaId(long pages, long pagesHashed, long pagesOld) {
		this.pages = pages;
		this.pagesHashed = pagesHashed;
		this.pagesOld = pagesOld;
	}

	public InnodbBufferStatsBySchemaId(String objectSchema, String allocated, String data, long pages, long pagesHashed,
			long pagesOld, BigInteger rowsCached) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InnodbBufferStatsBySchemaId))
			return false;
		InnodbBufferStatsBySchemaId castOther = (InnodbBufferStatsBySchemaId) other;
